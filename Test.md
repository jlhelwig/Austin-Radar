...
## 2. Live Logic
- **Thresholds**: 
  - **DEV**: 1 signal = Push triggered (Bypass). Verify "Noise Opt-Out" toggle mutes alerts.
  - **PROD**: 1 signal = No push; 2 signals = Push triggered.
...
- **PROD Moderation**: AI Safety Net (Edge Functions) checks + 3-vote community unlock.
- **DEV Moderation**: Verify "Moderation Bypass" allows instant submission for rapid testing.
